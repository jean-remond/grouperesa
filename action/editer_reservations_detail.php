 ...
 * D'apres v1.21.35 pour etude fonctionelle
 *
 ...
 * 
 * @todo: JR-19/12/2016-Trouver autre moyen pour id_resa_grp.
 * Fait ;
 * JR-19/12/2016-Correction faute de frappe pour la cle 'id_reservations_detail' dans pre_edition et post_edition.
 * JR-19/12/2016-Ajout force du champ id-resa_grp pour etablir la relation avec reservations_detail dans post_edition
 */
...
function reservations_detail_instituer($id_reservations_detail, $c, $calcul_rub = true) {
	...
	// Pipeline
	// JR-19/12/2016-Ajout force du champ id-resa_grp pour etablir la relation avec reservations_detail en post_edition
	$champs['id_resa_grp'] = _request('id_resa_grp');
	
	/*$debug1= "DEBUG grouperesa JR : action/editer_reservations_detail.php - reservations_detail_instituer - Pt032 -";
	spip_log("$debug1.", true);
	$id_resa_grp_log = $champs ['id_resa_grp'];
	spip_log("id_resa_grp(champs) = $id_resa_grp_log.", true);
